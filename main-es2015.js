...
class NgTimeChartComponent {
    ...
    ngOnInit() {
        ...
        this.periodChange
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(period => this.enumerateMonths(period)))
            .subscribe(months => this.months = months);
        this.periodChange
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(period => this.enumerateWeeks(period)))
            .subscribe(weeks => this.weeks = weeks);
        this.periodChange
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(period => this.enumerateDays(period)))
    ...
    changeYear(year) {
        ...
        if (this.startDate && this.endDate) {
            ...
            this.periodChange.next(new _period__WEBPACK_IMPORTED_MODULE_3__["Period"](moment(`${year}-01-01`).hour(12), moment(`${year}-12-31`).hour(23)));
        }
    }
    open(group) {
        group.onClick();
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["ng-tl-root"]], decls: 6, vars: 4, consts: [[2, "text-align", "center"], [2, "height", "400px"], [3, "groups", "startDate", "endDate"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
