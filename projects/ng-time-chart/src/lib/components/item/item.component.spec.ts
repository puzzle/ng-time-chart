...
describe('ItemComponent', () => {
  ...
  it('should calculate the day of period correctly', () => {
    expect(component.itemComponent.getDayOfPeriod(DateTime('2020-10-08')))
      .toEqual(281);
  });

  it('should calculate the day of period with late time correctly', () => {
    expect(component.itemComponent.getDayOfPeriod(DateTime('2020-10-08T23:34')))
      .toEqual(281);
  });

  it('should calculate the day of period with early time correctly', () => {
    expect(component.itemComponent.getDayOfPeriod(DateTime('2020-10-08T00:00')))
      .toEqual(281);
  });

  it('should calculate the affected days since a date', () => {
    expect(component.itemComponent.getDaysSince(DateTime('2020-01-02'), DateTime('2020-01-04')))
      .toEqual(2);
  });

  it('should calculate the days since a date with late time', () => {
    expect(component.itemComponent.getDaysSince(DateTime('2020-01-02T23:23'), DateTime('2020-01-04')))
      .toEqual(2);
  });

  it('should calculate the days since a date with late time 2', () => {
    expect(component.itemComponent.getDaysSince(DateTime('2020-01-02'), DateTime('2020-01-04T23:45')))
      .toEqual(2);
  });

  it('should calculate the days since a date with late time 3', () => {
    expect(component.itemComponent.getDaysSince(DateTime('2020-01-02T00:54'), DateTime('2020-01-04T23:45')))
      .toEqual(2);
  });

  it('should calculate the days since a date with early time', () => {
    expect(component.itemComponent.getDaysSince(DateTime('2020-01-02T00:54'), DateTime('2020-01-04T00:01')))
      .toEqual(2);
  });

  it('should calculate the days since a date with early time 2', () => {
    expect(component.itemComponent.getDaysSince(DateTime('2020-01-02T23:54'), DateTime('2020-01-04T00:01')))
      .toEqual(2);
  });
  ...
  it('should calculate the duration of an item 2', () => {
    const item = {
      name: 'testItem',
      startTime: DateTime('2020-05-01T23:59'),
      endTime: DateTime('2020-05-20T00:00'),
    };
    expect(component.itemComponent.getDuration(item))
      .toEqual(20);
  });
  ...
  it('should calculate the duration of an item 3', () => {
    const item = {
      name: 'testItem',
      startTime: DateTime('2020-05-01T00:00'),
      endTime: DateTime('2020-05-20T23:59'),
    };
    expect(component.itemComponent.getDuration(item))
      .toEqual(20);
  });
  ...
  it('should be visible when start is before and end is after the view period', () => {
    const item = {
      name: 'testItem',
      startTime: DateTime('2019-05-01T00:00'),
      endTime: DateTime('2021-05-20T23:59'),
    };
